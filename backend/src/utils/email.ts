...
function getBody(customerName?: string | null, lang?: string | null): string {
  ...
  if (lang === "ro") {
    return [
      ...
      "",
      "Daca ai creat cont, il poti descarca din nou oricand din istoricul tau CVPerfect.",
      "",
      "Cu drag,",
      "Echipa CVPerfect",
    ].join("\n");
  ...
  return [
    ...
    "",
    "If you created an account, you can download it again anytime from your CVPerfect history.",
    "",
    "Best,",
    "The CVPerfect team",
  ].join("\n");
