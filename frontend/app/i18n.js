...
const UI_COPY = {
  ro: {
    ...
    account: {
      title: "Contul tău",
      subtitle: "Autentifică-te ca să salvezi CV-uri și să vezi istoricul.",
      accountButton: "Cont",
      accountButtonSignedIn: "Cont ✓",
      notConfigured: "Conturile nu sunt configurate încă. Adaugă variabilele Supabase în Render și rulează SQL-ul de setup.",
      emailLabel: "Email",
      emailPlaceholder: "nume@email.ro",
      sendLink: "Trimite link de autentificare",
      sendingLink: "Se trimite...",
      loginHint: "Vei primi un link pe email. După click revii aici autentificat, fără parolă.",
      linkSent: "Am trimis linkul de autentificare pe email.",
      loginError: "Nu s-a putut trimite linkul de autentificare.",
      logout: "Ieși din cont",
      loggedOut: "Ai ieșit din cont.",
      loginRequired: "Autentifică-te ca să salvezi CV-ul în cont.",
      saveCurrent: "Salvează CV-ul curent",
      saving: "Se salvează...",
      saved: "CV salvat în cont.",
      saveError: "Nu s-a putut salva CV-ul.",
      loadError: "Nu s-au putut încărca datele contului.",
      nothingToSave: "Nu ai încă un CV deschis de salvat.",
      savedResumes: "CV-uri salvate",
      noResumes: "Nu ai încă CV-uri salvate.",
      purchaseHistory: "Istoric cumpărări",
      noPurchases: "Nu ai încă descărcări plătite în acest cont.",
  ...
  en: {
    ...
    account: {
      title: "Your Account",
      subtitle: "Sign in to save resumes and view your history.",
      accountButton: "Account",
      accountButtonSignedIn: "Account ✓",
      notConfigured: "Accounts are not configured yet. Add the Supabase variables in Render and run the setup SQL.",
      emailLabel: "Email",
      emailPlaceholder: "name@email.com",
      sendLink: "Send sign-in link",
      sendingLink: "Sending...",
      loginHint: "You will receive an email link. After clicking it, you return here signed in, with no password.",
      linkSent: "We sent the sign-in link to your email.",
      loginError: "Could not send the sign-in link.",
      logout: "Sign out",
      loggedOut: "You signed out.",
      loginRequired: "Sign in to save this resume to your account.",
      saveCurrent: "Save current CV",
      saving: "Saving...",
      saved: "CV saved to your account.",
      saveError: "Could not save this CV.",
      loadError: "Could not load account data.",
      nothingToSave: "There is no open CV to save yet.",
      savedResumes: "Saved CVs",
      noResumes: "You do not have saved CVs yet.",
      purchaseHistory: "Purchase history",
      noPurchases: "You do not have paid downloads in this account yet.",
      downloadAgain: "Download again",
      untitledResume: "Untitled CV",
      paid: "Paid",
    },
    errors: {
